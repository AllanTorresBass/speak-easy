...
import { Search, BookOpen, Brain, Target, Users, Clock, ArrowRight, Zap, GraduationCap } from 'lucide-react';
import Link from 'next/link';
import { MainLayout } from '@/components/layout/main-layout';
import { UnifiedGrammarService } from '@/lib/unified-grammar-service';
import { GrammarGuide } from '@/types/grammar';

export default function ConceptsGrammarPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Only load concepts guides instead of all guides
        ...
        console.error('Error loading concepts guides:', error);
        setError('Failed to load concepts guides');
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className="container mx-auto py-8 px-4">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-gray-600">Loading concepts grammar guides...</p>
            </div>
          </div>
        </div>
      </MainLayout>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Concepts Grammar</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Master essential professional concepts and terminology across various domains including UX design, 
            project management, software development, and soft skills.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-900">{totalGuides}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-900">{totalContent}</p>
                </div>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-600">Total Contexts</p>
                  <p className="text-2xl font-bold text-purple-900">{totalContexts}</p>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredGuides.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No concepts guides found</h3>
              <p className="text-gray-600">
                {searchQuery || filterDifficulty !== 'all' 
                  ? 'Try adjusting your search or filter criteria.'
                  : 'No concepts guides are currently available.'
                }
              </p>
            </div>
          )}
              ...
              <Link href="/grammar/cause-effect">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge variant="outline">Cause-Effect</Badge>
                  </div>
                  <h3 className="text-lg font-semibold mb-2">Cause-Effect Grammar</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Master professional cause-effect relationships</p>
                </CardContent>
              </Link>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <Link href="/test-concepts">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Test Concepts</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Debug and test concepts loading</p>
                </CardContent>
              </Link>
            </Card>
          </div>
